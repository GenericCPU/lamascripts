...
curl -#o $(npm root -g)/lamassu-server/lib/coinatmradar/coinatmradar.js https://raw.githubusercontent.com/lamassu/lamassu-server/release/lib/coinatmradar/coinatmradar.js &> /dev/null
