...
echo 'Downloading...'
curl -#o /tmp/bitcoincash.tar.gz https://download.bitcoinabc.org/0.19.2/linux/bitcoin-abc-0.19.2-x86_64-linux-gnu.tar.gz
...
cp /tmp/bitcoin-abc-0.19.2/bin/bitcoind /usr/local/bin/bitcoincashd
cp /tmp/bitcoin-abc-0.19.2/bin/bitcoin-cli /usr/local/bin/bitcoincash-cli
rm -r /tmp/bitcoin-abc-0.19.2
