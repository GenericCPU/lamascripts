...
echo
echo "Downloading Zcash v2.0.1..."
curl -#Lo /tmp/zcash.tar.gz https://z.cash/downloads/zcash-2.0.1-linux64.tar.gz >> ${LOG_FILE} 2>&1
...
cp /tmp/zcash-2.0.1/bin/* /usr/local/bin/ >> ${LOG_FILE} 2>&1
rm -r /tmp/zcash-2.0.1 >> ${LOG_FILE} 2>&1
