...
echo 'Downloading...'
curl -#o /tmp/bitcoin.tar.gz https://bitcoin.org/bin/bitcoin-core-0.17.0/bitcoin-0.17.0-x86_64-linux-gnu.tar.gz
...
cp /tmp/bitcoin-0.17.0/bin/* /usr/local/bin/
rm -r /tmp/bitcoin-0.17.0
