...
echo 'Downloading...'
curl -#o /tmp/bitcoin.tar.gz https://bitcoin.org/bin/bitcoin-core-0.16.2/bitcoin-0.16.2-x86_64-linux-gnu.tar.gz
...
cp /tmp/bitcoin-0.16.2/bin/* /usr/local/bin/
rm -r /tmp/bitcoin-0.16.2
