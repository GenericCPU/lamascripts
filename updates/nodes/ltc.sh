...
echo 'Downloading...'
curl -#o /tmp/litecoin.tar.gz https://download.litecoin.org/litecoin-0.16.2/linux/litecoin-0.16.2-x86_64-linux-gnu.tar.gz
...
cp /tmp/litecoin-0.16.2/bin/* /usr/local/bin/
rm -r /tmp/litecoin-0.16.2
