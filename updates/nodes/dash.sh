...
echo 'Downloading...'
curl -#Lo /tmp/dash.tar.gz https://github.com/dashpay/dash/releases/download/v0.13.2.0/dashcore-0.13.2.0-x86_64-linux-gnu.tar.gz
...
cp /tmp/dashcore-0.13.2/bin/* /usr/local/bin/
rm -r /tmp/dashcore-0.13.2
rm /tmp/dash.tar.gz
