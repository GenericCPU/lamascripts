...
echo 'Updating Dash...'
curl -#Lo /tmp/dash.tar.gz https://github.com/dashpay/dash/releases/download/v0.14.0.0/dashcore-0.14.0.0-x86_64-linux-gnu.tar.gz  &>/dev/null
...
curl -#o /etc/supervisor/conf.d/dash.conf https://raw.githubusercontent.com/LamassuSupport/lamascripts/master/switches/reindex/dash-orig.conf  &>/dev/null
